...
const ProjectCard = ( props ) => {
  return (
    <div>
      <div className='p-5 rounded-xl lg:w-[360px] w-full' style={{backgroundColor: "#d1e2f3"}}>
  ...
  return (
    ...
    <div className="mx-28 pb-20 pt-28 text-center lg:text-left">
      ...
      <div className='mt-10 flex flex-wrap gap-7'>      
          ...
          <ProjectCard imagePath={Image2} name="Cinema App" description="In this project, I developed a dynamic and responsive web application that allows users to browse and discover various makeup products from Maybelline. Public API Used: http://makeup-api.herokuapp.com/" github="https://github.com/sofijalazarova/makeUpApp" website_link="https://sofijalazarova.github.io/makeUpApp/" tech="React, Vite, Tailwind CSS, Axios"/>
      </div>
      </div>
    </>
  );
